...
=item CreateLayer
  ...
  $layer = $datasource->CreateLayer('layer_name', 
    ...
    $geom_type = $Geo::OGR::wkbUnknown, $options = []);
...
=item CreateField
  ...
  $column = new Geo::OGR::FieldDefn('my_field', 
    $Geo::OGR::OFTInteger); # an example
...
=head2 Geo::OGR::FeatureDefn (Schema)
...
=head2 Geo::OGR::FieldDefn (Column)
...
L<perl>(1), L<Geo::GDAL>(3pm), L<Geo::GDAL::Const>(3pm), L<Geo::OSR>(3pm).
